...
def sql_filter_pis(
    ...
    results = con.execute(f"""
        SELECT
            ...
            p.research_description, p.paper_count, p.paper_count_last_3_years,
    ...
    return [
        {
            ...
            "paper_count": r[11],
            "paper_count_last_3_years": r[12],
            "personal_url": r[13],
            "lab_url": r[14],
            "email": r[15],
            "lab_name": r[16],
            "taking_students_confidence": r[17],
            "taking_students_checked_at": r[18],
            "institution_name": r[19],
            "region": r[20],
            "country": r[21],
        }
        for r in results
